...
This will make all &lt;p> elements rendered with 8px-wide bottom border, green(#0F0) left border, red(#F00) right border, and 1px-wide top border, like this:
